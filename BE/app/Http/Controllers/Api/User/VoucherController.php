...
class VoucherController extends Controller
{
    ...
    public function applyVoucher(Request $request)
    {
        try {
            ...
            $userId = $user ? $user->id : null; // Lấy người dùng thông qua Sanctum token
            ...
            if ($voucher->for_logged_in_users == 1 && !$userId) {
                return response()->json(['message' => 'Voucher này chỉ dành cho người dùng đã đăng nhập','data'=>$voucher,'user'=>$user], 403);
                }
